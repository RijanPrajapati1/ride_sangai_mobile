  ...
  List<RideDto> _seedRides() {
    ...
    return [
      ...
      RideDto(
        ...
        description:
            'A classic 3-day teahouse trek through rhododendron forests to the Poon Hill '
            'viewpoint for a 360° sunrise over the Annapurna and Dhaulagiri ranges.',
        date: at(18, 5, 0),
        meetingPoint: 'Pokhara Baglung Bus Park',
        rideType: RideType.multiDayTrek,
        difficulty: RideDifficulty.moderate,
        distanceKm: 38,
        ...
        organizerName: DummyPeople.suresh.name,
        organizerAvatarUrl: DummyPeople.suresh.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/poonhill-trek/900/600',
        participantCount: 9,
        maxParticipants: 14,
        requirements: const ['Trekking poles', 'Warm layers', 'Tea house booking confirmed'],
        participantAvatars: [DummyPeople.anita.avatarUrl, DummyPeople.roshani.avatarUrl],
      ),
      RideDto(
        id: 'r_102',
        title: 'Mardi Himal Base Camp Trek',
        description:
            'A 4-day off-the-beaten-path trek through forest and ridge trails to Mardi Himal '
            'Base Camp, with close-up views of Machapuchare.',
        date: at(30, 5, 30),
        ...
        organizerName: DummyPeople.anita.name,
        organizerAvatarUrl: DummyPeople.anita.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/mardi-himal-trek/900/600',
        participantCount: 6,
        maxParticipants: 10,
        requirements: const ['Trekking poles', 'Down jacket', 'Headlamp'],
        participantAvatars: [DummyPeople.suresh.avatarUrl],
      ),
      RideDto(
        id: 'r_103',
        title: 'Langtang Valley Trek',
        description:
            'A 7-day Himalayan trek through the Langtang valley, Tamang villages, and glacial '
            'moraines just north of Kathmandu.',
        date: at(45, 5, 0),
        ...
        organizerName: DummyPeople.suresh.name,
        organizerAvatarUrl: DummyPeople.suresh.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/langtang-trek/900/600',
        participantCount: 5,
        maxParticipants: 12,
        requirements: const ['Trekking permit (TIMS)', 'Sleeping bag', 'Water purification tablets'],
        participantAvatars: [DummyPeople.aarav.avatarUrl, DummyPeople.anita.avatarUrl],
      ),
      RideDto(
        id: 'r_104',
        title: 'Chisapani–Nagarkot Ridge Trek',
        description:
            'A 2-day ridge trek from Chisapani to Nagarkot along the rim of the Kathmandu '
            'valley, with wide Himalayan views at sunrise.',
        date: at(10, 6, 0),
        meetingPoint: 'Sundarijal Gate',
        rideType: RideType.summitTrek,
        difficulty: RideDifficulty.moderate,
        distanceKm: 32,
        ...
        organizerName: DummyPeople.aarav.name,
        organizerAvatarUrl: DummyPeople.aarav.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/chisapani-nagarkot-trek/900/600',
        participantCount: 11,
        maxParticipants: 16,
        requirements: const ['Trekking poles', 'Rain jacket'],
        participantAvatars: [DummyPeople.kabita.avatarUrl],
      ),
      ...
      RideDto(
        ...
        description:
            'A steep climb to Phulchowki, the highest hill rim of the Kathmandu valley, '
            'through birding trails and dense forest.',
        date: at(6, 6, 30),
        meetingPoint: 'Godavari Botanical Garden Gate',
        rideType: RideType.dayHike,
        difficulty: RideDifficulty.moderate,
        distanceKm: 16,
        durationMinutes: 300,
        organizerId: DummyPeople.sabina.id,
        organizerName: DummyPeople.sabina.name,
        organizerAvatarUrl: DummyPeople.sabina.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/phulchowki-hike/900/600',
        participantCount: 14,
        maxParticipants: 20,
        requirements: const ['Trekking shoes', 'Water bottle'],
        participantAvatars: [DummyPeople.dipesh.avatarUrl],
      ),
      RideDto(
        id: 'r_106',
        ...
        description:
            'A shaded, easy loop through Nagarjun Forest Reserve up to the Jamacho viewpoint, '
            'popular with birdwatchers and families.',
        date: at(3, 7, 0),
        meetingPoint: 'Nagarjun Gate, Balaju',
        rideType: RideType.natureWalk,
        difficulty: RideDifficulty.easy,
        distanceKm: 8,
        durationMinutes: 150,
        organizerId: DummyPeople.kabita.id,
        organizerName: DummyPeople.kabita.name,
        organizerAvatarUrl: DummyPeople.kabita.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/nagarjun-hike/900/600',
        participantCount: 18,
        maxParticipants: 25,
        requirements: const ['Park entry fee', 'Water bottle'],
        participantAvatars: [DummyPeople.sabina.avatarUrl, DummyPeople.roshani.avatarUrl],
      ),
      RideDto(
        id: 'r_107',
        title: 'Sundarijal to Chisapani Hike',
        description:
            'A rewarding day hike along the Bagmati source, climbing through Shivapuri '
            'National Park to the Chisapani ridge.',
        date: at(9, 6, 15),
        ...
        organizerName: DummyPeople.sabina.name,
        organizerAvatarUrl: DummyPeople.sabina.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/sundarijal-hike/900/600',
        participantCount: 10,
        maxParticipants: 18,
        requirements: const ['Park entry fee', 'Trekking shoes', 'Packed lunch'],
        participantAvatars: [DummyPeople.kabita.avatarUrl],
      ),
      RideDto(
        id: 'r_108',
        ...
        description:
            'A gentle, family-friendly hike up Champadevi hill with a picnic stop and views '
            'over the whole Kathmandu valley.',
        date: at(4, 7, 30),
        meetingPoint: 'Pharping Chowk',
        rideType: RideType.familyHike,
        difficulty: RideDifficulty.easy,
        distanceKm: 9,
        durationMinutes: 210,
        organizerId: DummyPeople.kabita.id,
        organizerName: DummyPeople.kabita.name,
        organizerAvatarUrl: DummyPeople.kabita.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/champadevi-hike/900/600',
        participantCount: 15,
        maxParticipants: 25,
        requirements: const ['Water bottle', 'Snacks'],
        participantAvatars: [DummyPeople.sabina.avatarUrl],
      ),
      ...
      RideDto(
        ...
        description:
            'An evening motorbike cruise up to Nagarkot for city lights and a late dinner, '
            'back down before midnight.',
        date: at(7, 17, 30),
        meetingPoint: 'Bhaktapur Bypass, Bhaktapur',
        rideType: RideType.touringRide,
        difficulty: RideDifficulty.easy,
        distanceKm: 52,
        durationMinutes: 150,
        organizerId: DummyPeople.nischal.id,
        organizerName: DummyPeople.nischal.name,
        organizerAvatarUrl: DummyPeople.nischal.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/nagarkot-night-ride/900/600',
        participantCount: 13,
        maxParticipants: 20,
        requirements: const ['Riding license', 'Helmet (mandatory)', 'Reflective jacket'],
        participantAvatars: [DummyPeople.dipesh.avatarUrl],
      ),
      RideDto(
        id: 'r_110',
        ...
        description:
            'A full-day highway run to Chitwan for lunch by the Narayani river before heading '
            'back to the valley.',
        date: at(16, 6, 0),
        ...
        organizerName: DummyPeople.nischal.name,
        organizerAvatarUrl: DummyPeople.nischal.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/chitwan-ride/900/600',
        participantCount: 9,
        maxParticipants: 15,
        requirements: const ['Riding license', 'Helmet (mandatory)', 'Full tank'],
        participantAvatars: [DummyPeople.dipesh.avatarUrl, DummyPeople.aarav.avatarUrl],
      ),
      RideDto(
        id: 'r_111',
        title: 'Shivapuri Off-Road Trail Ride',
        description:
            'A technical off-road ride through the fire roads of Shivapuri National Park for '
            'dual-sport and adventure bikes.',
        date: at(12, 6, 30),
        meetingPoint: 'Sundarijal Gate',
        rideType: RideType.offRoadRide,
        difficulty: RideDifficulty.hard,
        distanceKm: 45,
        durationMinutes: 240,
        organizerId: DummyPeople.dipesh.id,
        organizerName: DummyPeople.dipesh.name,
        organizerAvatarUrl: DummyPeople.dipesh.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/shivapuri-offroad-ride/900/600',
        participantCount: 7,
        maxParticipants: 12,
        requirements: const ['Dual-sport or adventure bike', 'Riding gear', 'Park entry fee'],
        participantAvatars: [DummyPeople.nischal.avatarUrl],
      ),
      RideDto(
        id: 'r_112',
        title: 'Mustang Overland Ride',
        description:
            "A 3-day overland motorbike expedition to Upper Mustang's high-desert landscapes "
        ...
        organizerName: DummyPeople.nischal.name,
        organizerAvatarUrl: DummyPeople.nischal.avatarUrl,
        imageUrl: 'https://picsum.photos/seed/mustang-ride/900/600',
        participantCount: 6,
        maxParticipants: 10,
        requirements: const ['Restricted area permit', 'Adventure/touring bike', 'Riding gear'],
        participantAvatars: [DummyPeople.dipesh.avatarUrl],
      ),
    ];
  }
